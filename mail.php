...
if($_POST['dropdown']!=NULL){ $dropdown=$_POST['dropdown']; }
if($_POST['message']!=NULL){ $message=$_POST['message']; }


if($email != NULL || $mobile != NULL || $mobile != '')
{
date_default_timezone_set("Asia/Kolkata");

$subject = 'Enquiry for Rubrick';
        ...
        <tr>
            <td width='100%' align='center' valign='top'>
                ...
                <table width='600' border='0' cellpadding='0' cellspacing='0' align='center' class='container' bgcolor='ffffff'>
                    ...
                    <tr bgcolor='ffffff'>
                        <td height='40' style='text-align:center;'> Enquiry For Rubrick</td>
                    </tr>
                    <tr>
                        <td>
                            <table border='0' width='560' align='center' cellpadding='0' cellspacing='0' class='container-middle'>
...
// 		CURLOPT_POST => true,
// 		CURLOPT_POSTFIELDS => [
// 			'secret' => '6Lft5NkUAAAAAN_aHgWY1gMSxbghmHrQMc1pScAu',
// 			'response' => $_POST["g-recaptcha-response"],
...
// 	} else if ($json->success==true) {
	...
	$mail = new PHPMailer();		
    	$mail->From      = 'noreply@rubrick.in';		
    	$mail->FromName  = "Rubrick Enquiry";		
    	$mail->Subject   = $subject;		
    	$mail->Body      = $message;		
    	$mail->SetFrom( "noreply@rubrick.in", 'Rubrick Enquiry');
    
              $mail->AddAddress('bhuvanakrishna@grank.co.in', 'Rubrick');
            //   $mail->AddAddress('maneeshkumar@grank.co.in', 'Rubrick');
   
    // $mail->AddCC('rubrickconstructions@gmail.com', 'Rubrick');
    // $mail->AddCC('maneeshkumar@grank.co.in', 'Rubrick');
...
if($mail->send())
    {  
        echo "Email sent Successfully for contact form";
