...
<div class="fixed_side_icons desktop_cta">
    ...
    <a class="fixed_wa" href="https://api.whatsapp.com/send?phone=916309487999" target="_blank"><i class="fa fa-whatsapp"></i></a>
</div>
<div class="modal fade" id="myModal_enquire" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
          <form id="popUpEnquireNowForm" action="https://seoanswernet.com/mail/rubrickmail.php" method="post">
...
<div class="modal fade" id="myModal_brochure" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
          <form id="popUpDownloadBrochureForm" action="https://seoanswernet.com/mail/rubrickbrochuremail.php" method="post">
              <div class="site-visit mt-none-10">
                <div class="form-group mt-10">
...
<div class="modal fade" id="myModal_visit" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
          <form id="popUpSiteVisitForm" action="https://seoanswernet.com/mail/rubrickvisitmail.php" method="post">
              <div class="site-visit mt-none-10">
                <div class="form-group mt-10">
